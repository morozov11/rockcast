...
pub struct Strings {
    ...
    pub station_search_action: &'static str,
...
pub static RU: Strings = Strings {
    ...
    stations: "Станции",
    refresh: "Вернуться на главный экран",
    station_search: "Поиск станций или жанра",
    station_search_action: "Искать",
    genres: "Жанры",
    col_station: "Станция",
    col_tags: "Теги",
    col_country: "Страна",
...
pub static EN: Strings = Strings {
    ...
    station_search: "Search stations or genre",
    station_search_action: "Search",
    genres: "Genres",
    col_station: "Station",
    col_tags: "Tags",
    col_country: "Country",
