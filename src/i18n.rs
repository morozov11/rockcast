...
pub struct Strings {
    ...
    pub account_auth_required: &'static str,
...
pub static RU: Strings = Strings {
    ...
    account_auth_required: "Сессия аккаунта требует повторного подключения. Локальное радио продолжает работать.",
...
pub static EN: Strings = Strings {
    ...
    account_auth_required: "Your account session needs reconnecting. Local radio remains available.",
